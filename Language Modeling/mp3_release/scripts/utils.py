...
def convert_line(line, vocab):
    ...
    Output
    -------------
    line_data: List[char]. List of indices corresponding to the characters
                in the input line.
    """
    line_data = []
    for charac in line:
...
def convert_files(files, vocab):
    ...
    Output
    ---------------
    data: List[List[char]]. List of lists where each inner list is a list of character
            indices corresponding to a line in the training split.
    """
    data = []
