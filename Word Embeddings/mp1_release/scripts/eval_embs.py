...
def get_eval_stats(emb_file):   
    ...
    sim = wv.evaluate_word_pairs(os.getcwd()+"/../test_files/wordsim_similarity_goldstandard.txt")
    analogy = wv.evaluate_word_analogies(os.getcwd()+"/../test_files/questions-words_headered.txt")
